...
Future<OneWayAnywhereResults> fetchOneWayAnywhereResults() async {
  ...
  final response = await http.get(Uri.parse('https://www.ryanair.com/api/farfnd/3/oneWayFares?=&departureAirportIataCode=${DepAirport.getDepAirportCode()}&language=en&limit=16&market=en-gb&offset=0&outboundDepartureDateFrom=${DepAirport.getFromDateSelected()}&outboundDepartureDateTo=${DepAirport.getToDateSelected()}&priceValueTo=2000'));

  try{

    final results = OneWayAnywhereResults.fromJson(json.decode(response.body));
