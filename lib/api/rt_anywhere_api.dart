...
Future<RoundtripAnywhereResults> fetchRoundtripAnywhereResults() async {
  ...
  final response = await http.get(Uri.parse('https://www.ryanair.com/api/farfnd/3/roundTripFares?&departureAirportIataCode=${DepAirport.getDepAirportCode()}&durationFrom=${DepAirport.getdurationFrom()}&durationTo=${DepAirport.getdurationTo()}&inboundDepartureDateFrom=${DepAirport.getFromDateSelected()}&inboundDepartureDateTo=${DepAirport.getToDateSelected()}&language=en&limit=16&market=en-gb&offset=0&outboundDepartureDateFrom=${DepAirport.getFromDateSelected()}&outboundDepartureDateTo=${DepAirport.getToDateSelected()}&priceValueTo=2000'));
  ...
  try{
    ...
    final results = RoundtripAnywhereResults.fromJson(json.decode(response.body));
