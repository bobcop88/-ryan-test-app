      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    checkedValue ? 'Anywhere' : destAirportName,
                                                    style: TextStyle(
                                                    fontSize: 17.0,
                                                    fontWeight: FontWeight.bold,
                                                    color: Color(0xFF073590),
            ...
            //       children: [
            //         Text(
            //           DepAirport.getDepAirportCode() == null ? 'Wait' : DepAirport.getDepAirportCode().toString(),
            //         ),
            //         Text(
            //           DepAirport.getFromDateSelected() == null ? 'Wait' : DepAirport.getFromDateSelected().toString(),
            //         ),
            //         Text(
            //           DepAirport.getToDateSelected() == null ? 'Wait' : DepAirport.getToDateSelected().toString(),
            //         ),
            //       ],
            //     ),
