                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            DateFormat("dd MMMM yyyy").format(DateTime.parse(snapshot.data!.outDepDate.split('T')[0])),
                                            style: TextStyle(
                                              fontSize: 18.0,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            TextButton(
                                              ...
                                              child: _textOutbound ? Text('Flight Details') : Text('Hide Details') , 
                                            ),
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          snapshot.data!.outPriceValue.toString()+snapshot.data!.outCurrencyCode,
                                                                          style: TextStyle(
                                                                            color: Color(0xFF073590),
                                                                            fontWeight: FontWeight.bold
                                                                          ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            DateFormat("dd MMMM yyyy").format(DateTime.parse(snapshot.data!.inDepDate.split('T')[0])),
                                            style: TextStyle(
                                              fontSize: 18.0,
                                              fontWeight: FontWeight.bold,
                                              color: Color(0xFF073590),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            TextButton(
                                              ...
                                              child: _textInbound ? Text('Flight Details') : Text('Hide Details') , 
                                            ),
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          snapshot.data!.inPriceValue.toString()+snapshot.data!.inCurrencyCode,
                                                                          style: TextStyle(
                                                                            color: Color(0xFF073590),
                                                                            fontWeight: FontWeight.bold
                                                                          ),
